...
# created by OdzioM
# script filename: libadwaita-tc-gui-10.py
#
############################################
...
class ThemeChanger:
    ...
    def create_menu(self):
        ...
        options_menu.add_command(label="Settings", command=self.settings_screen, accelerator="Alt+O")
    ...
    def settings_screen(self, error_message=None):
        ...
        tk.Button(frame, text="Cancel", command=settings_window.destroy).pack(fill="x")
